...
A Polar H10 ECG and HRV monitor built with pure HTML5 and Web Bluetooth API.
...
## Use the app
Use the link in the repository's *About* section to go to the app. On a desktop browser it generally should be in that direction ↗️.
